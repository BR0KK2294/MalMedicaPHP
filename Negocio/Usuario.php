...
{  private $id_usuario;
   ...
   public function ingresarUsuario()
      { $objConex=new Conexion();
        $sql="INSERT INTO usuario VALUES('".$this->id_usuario."','".$this->login_usuario."','".$this->pass_usuario."','".$this->nombre_usuario."','".$this->apellido_usuario."','".$this->correo_usuario."','".$this->edad_usuario."','".$this->fecha_nacimiento."','".$this->id_perfil."')";
...
public function modificarUsuario()
   { $objConex=new Conexion();
     $sql="UPDATE usuario SET LOGIN_USUARIO='".$this->login_usuario."',PASS_USUARIO='".$this->pass_usuario."',NOMBRE_USUARIO='".$this->nombre_usuario."',APELLIDO_USUARIO='".$this->apellido_usuario."',CORREO_USUARIO='".$this->correo_usuario."',EDAD_USUARIO='".$this->edad_usuario."',FECHA_NACIMIENTO='".$this->fecha_nacimiento."',ID_PERFIL='".$this->id_perfil."'  WHERE(ID_USUARIO=".$this->id_usuario.")";
     $resul=$objConex->generarTransaccion($sql);
     return $resul;
   }
